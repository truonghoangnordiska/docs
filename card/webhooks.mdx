...
The card service uses an event-driven architecture with guaranteed delivery and ordered processing:
...
5. **Distributed Processing**: Multiple service instances coordinate using distributed locks

## Configuration

<Warning>
Webhook endpoints must be configured by your integration contact before going live. Configuration includes the webhook URL, signing secret, and optional authentication header.
</Warning>
